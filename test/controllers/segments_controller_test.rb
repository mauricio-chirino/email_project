...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference("Segment.count") do
      post segments_url, params: { segment: { company_id: @segment.company_id, name: @segment.name } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { company_id: @segment.company_id, name: @segment.name } }
