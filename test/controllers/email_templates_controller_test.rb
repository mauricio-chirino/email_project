...
class EmailTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_template" do
    assert_difference("EmailTemplate.count") do
      post email_templates_url, params: { email_template: { campaign_id: @email_template.campaign_id, content: @email_template.content, name: @email_template.name } }
    end
  ...
  test "should update email_template" do
    patch email_template_url(@email_template), params: { email_template: { campaign_id: @email_template.campaign_id, content: @email_template.content, name: @email_template.name } }
